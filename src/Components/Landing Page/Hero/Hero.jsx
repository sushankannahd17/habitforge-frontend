        ...
        <div className="w-1/4 flex-col xl:flex-row mt-36 ml-58">
          ...
          <ul className="inter-para text-gray-600 mt-10">
            <li className="flex mb-4">
              ...
              <p className="text-xl mt-2">Track daily habits with a single click</p>
            </li>
            <li className="flex mb-4">
              <span className="mt-2 mr-4">
                <FontAwesomeIcon icon={faCheck} className="text-blue-600 w-4 h-4" />
          ...
          <button className="h-16 w-1/2 border-white rounded-2xl bg-[#5B6CFF] text-white inter-para mt-5">
